...
ax.scatter(visual_hull1[:, 0], visual_hull1[:, 1], visual_hull1[:, 2], c='r', s=1, label='Visual Hull 1')
ax.scatter(visual_hull2_rotated[:, 0], visual_hull2_rotated[:, 1], visual_hull2_rotated[:, 2], c='b', s=1, label='Visual Hull 2 Rotated')
ax.set_xlabel('X')
ax.set_ylabel('Y')
ax.set_zlabel('Z')
ax.legend()
